...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    async function loadProfile() {
        try {
            ...
            if (data && data.id && data.name) {
                profileData = normalizeProfile(data);
                return;
            }
            ...
            <form id="profileForm">
                ...
                <section class="profile-card">
                    ...
                    <div class="profile-card-header">
                        ...
                        <div>
                            ...
                            <p>
                                ${escapeHTML(profileData.program)}
                            </p>
                    ...
                    <div class="profile-form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                type="text"
                                id="universityId"
                                value="${escapeHTML(profileData.university_id)}"
                            >
                        ...
                        <div class="form-group">
                            ...
                            <input
                                type="text"
                                id="year"
                                value="${escapeHTML(profileData.year)}"
                ...
                <section class="profile-card">
                    ...
                    <div class="profile-section-header">
                        ...
                        <div>
                            ...
                            <p>
                                Enter your current university program.
                            </p>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            type="text"
                            id="program"
                            value="${escapeHTML(profileData.program)}"
                        ...
                        <small class="form-help">
                            Enter your program exactly as you want it
                ...
                <section class="profile-card">
                    ...
                    <div class="form-group">
                        ...
                        >${escapeHTML(profileData.bio)}</textarea>
                    ...
                    <div class="profile-form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                type="url"
                                id="linkedin"
                                value="${escapeHTML(profileData.linkedin)}"
                        ...
                        <div class="form-group">
                            ...
                            <input
                                type="url"
                                id="github"
                                value="${escapeHTML(profileData.github)}"
    ...
    function renderSkillPreview() {
        ...
        if (!skillPreview || !skillsInput) {
            return;
        }

        const values = skillsInput.value
            .split(",")
            .map(skill => skill.trim())
            .filter(Boolean);
